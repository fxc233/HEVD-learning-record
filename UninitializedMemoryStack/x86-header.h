...
NtAllocateReserveObject_t NtAllocateReserveObject = NULL;
...
NtMapUserPhysicalPages_t NtMapUserPhysicalPages = NULL;
...
DWORD getpeb()
{
	//in NT kernel FS -> TEB *[TEB+0x30] -> PEB
